       ...
       <div class="container">
                ...
                <form method="post" action="../../../modules/acceptFile.php">
                    <div class="mb-3">
                        ...
                        <select class="form-select" aria-label="Default select example" name="paymentid" >  
                            <?php while($fetch3=mysqli_fetch_assoc($result3)) { ?>
                                <option value="<?= $fetch3['paymentid']?>"><?= $fetch3['fullname']?></option>
                            <?php } ?>
                        </select>
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="preparedby" value="<?=$user?>" readonly required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="remarks" value="<?=$fetch2['remarks']?>" >
                </div>
